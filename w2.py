...
<tbody>
<tr><td>李娜</td><td>linana</td><td><span class='bdg ba'>调度员</span></td><td>平台</td><td>2026-03-28 09:00</td><td><span class='bdg ae'>正常</span></td><td><button class='btn sm'>编辑</button></td></tr>
<tr><td>赵强</td><td>zhaoqiang</td><td><span class='bdg af2'>核损员</span></td><td>平台</td><td>2026-03-28 11:20</td><td><span class='bdg ae'>正常</span></td><td><button class='btn sm'>编辑</button></td></tr>
<tr><td>王芳</td><td>wangfang</td><td><span class='bdg ad'>互助给付员</span></td><td>平台</td><td>2026-03-28 08:45</td><td><span class='bdg ae'>正常</span></td><td><button class='btn sm'>编辑</button></td></tr>
<tr><td>陈伟</td><td>chenwei</td><td><span class='bdg ae'>财务</span></td><td>平台</td><td>2026-03-28 10:30</td><td><span class='bdg ae'>正常</span></td><td><button class='btn sm'>编辑</button></td></tr>
</tbody></table>
</div>
</div>
</div>
...
<div class='stat'><div class='val' style='color:var(--a)'>2</div><div class='lbl'>待确认给付</div><div class='sub'>待确认¥23,400</div></div>
...
with open(r'D:\workAIspace\openclaw\tscs-demo\c2.html', 'w', encoding='utf-8') as f:
    f.write(html)
print('c2.html written, len=', len(html))
