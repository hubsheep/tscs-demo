...
<div class='tm mb12'>已上传 0/20 张 · 必填：全景1 + 受损细节各1</div>
<button class='btn f2' style='width:100%;justify-content:center' onclick='sp("f","frec")'>下一步：笔录</button>
</div>
<div id='frec' class='card' style='margin:12px;display:none'>
<div class='hd f'>电子笔录</div>
<div class='fg'><div class='fl'>对方姓名</div><input class='in' placeholder='请输入'></div>
<div class='fg'><div class='fl'>对方电话</div><input class='in' placeholder='请输入'></div>
<div class='fg'><div class='fl'>对方车牌</div><input class='in' placeholder='请输入'></div>
<div class='fg'><div class='fl'>笔录描述</div><textarea class='in' rows='4' placeholder='请描述事故经过...'></textarea></div>
<div class='fx g8'>
<button class='btn' onclick='sp("f","fph")'>上一步</button>
<button class='btn f2' onclick='sp("f","fev")'>提交并评估</button>
</div>
</div>
<div id='fev' class='card' style='margin:12px;display:none'>
<div class='hd f'>损失评估</div>
<div class='ig mb12'>
<div class='ii'><div class='il'>三者车辆损失</div><div class='iv'>¥8,200</div></div>
<div class='ii'><div class='il'>本车损失</div><div class='iv'>¥7,600</div></div>
<div class='ii'><div class='il'>总损失</div><div class='iv m' style='color:var(--af)'>¥15,800</div></div>
<div class='ii'><div class='il'>责任比例</div><div class='iv'>主责 70%</div></div>
<div class='ii'><div class='il'>我方赔付额</div><div class='iv m' style='color:#ff4d4f'>¥10,710</div></div>
<div class='ii'><div class='il'>三者赔付额</div><div class='iv'>¥4,590</div></div>
</div>
<button class='btn f2' style='width:100%;justify-content:center' onclick='toast("评估已提交，等待平台审核")'>提交评估结果</button>
</div>
</div>
<div class='phbb'>
<div class='pht fpht on' onclick='phNav("f","fh",this)'><span class='ic'>🏠</span><span>工作台</span></div>
<div class='pht fpht' onclick='phNav("f","ft",this)'><span class='ic'>📋</span><span>任务</span></div>
<div class='pht fpht' onclick='phNav("f","fph",this)'><span class='ic'>📷</span><span>拍照</span></div>
<div class='pht fpht' onclick='phNav("f","fev",this)'><span class='ic'>📊</span><span>评估</span></div>
</div>
</div>
</div>
'''

with open(r'D:\workAIspace\openclaw\tscs-demo\c5.html', 'w', encoding='utf-8') as f:
    f.write(html)
print('c5.html written, len=', len(html))
