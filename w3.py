...
<tr><td>京B·12345</td><td>中型普通客车</td><td>旅游客运</td><td>李娜</td><td><span class='bdg ae'>在统</span></td><td>2026-12-31</td><td><button class='btn sm'>详情</button></td></tr>
...
with open(r'D:\workAIspace\openclaw\tscs-demo\c3.html', 'w', encoding='utf-8') as f:
    f.write(html)
print('c3.html written, len=', len(html))
